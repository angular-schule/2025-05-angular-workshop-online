...
* den Code als ZIP-Datei herunterladen: [rxjs-playground.zip](https://github.com/user-attachments/files/20272904/rxjs-playground.zip)<br>**oder**<br>
...
Öffne die Datei `src/app/app.component.html` im Projektordner `book-rating`. Lösche den gesamten Inhalt dieser Datei.

Anschließend füge in `app.component.html` bitte das folgende HTML ein. Es wird ein Layout-Container erzeugt und darin eine Überschrift angezeigt:
...
### &copy; https://angular.schule | Stand: 28.04.2025
